...
bool
ListNode ::insertAtIndex(std::pair<Key_t, Val_t> key, int index, uint8_t keyHash)
{
  keyArray[index] = key;
...
uint8_t
ListNode ::getKeyInsertIndex(Key_t key)
{
...
#if MAX_ENTRIES == 64
int
ListNode::getKeyIndex(Key_t key, uint8_t keyHash)
{
...
uint8_t
ListNode::getKeyFingerPrint(Key_t key)
{
