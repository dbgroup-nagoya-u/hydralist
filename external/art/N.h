...
class N
{
 ...
 public:
  ...
  static void removeAndUnlock(N *node,
                              uint8_t key,
                              N *parentNode,
                              uint8_t keyParent,
                              ThreadInfo &threadInfo,
  ...
  static void insertCompact(curN *n,
                            N *parentNode,
                            uint8_t keyParent,
                            uint8_t key,
                            N *val,
  ...
  static void removeAndShrink(curN *n,
                              N *parentNode,
                              uint8_t keyParent,
                              uint8_t key,
                              ThreadInfo &threadInfo,
  ...
  static void getChildren(const N *node,
                          uint8_t start,
                          uint8_t end,
...
class N4 : public N
{
 ...
 public:
  ...
  void getChildren(uint8_t start,
                   uint8_t end,
                   std::tuple<uint8_t, N *> *&children,
