...
inline void
DeletionList::remove(LabelDelete *label, LabelDelete *prev)
{
  if (prev == nullptr) {
...
inline void
DeletionList::add(void *n, uint64_t globalEpoch)
{
  deletitionListCount++;
  LabelDelete *label;
...
inline void
Epoche::enterEpoche(ThreadInfo &epocheInfo)
{
...
inline void
Epoche::markNodeForDeletion(void *n, ThreadInfo &epocheInfo)
{
...
inline void
Epoche::exitEpocheAndCleanup(ThreadInfo &epocheInfo)
{
...
inline DeletionList &
ThreadInfo::getDeletionList() const
{
  return deletionList;
}

inline Epoche &
ThreadInfo::getEpoche() const
{
  return epoche;
}
