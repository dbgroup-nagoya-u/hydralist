...
void
Oplog::enq(OpStruct::Operation op, Key_t &key, uint8_t hash, void *listNodePtr)
{
...
void
Oplog::enqPerThreadLog(OpStruct::Operation op, Key_t &key, uint8_t hash, void *listNodePtr)
{
