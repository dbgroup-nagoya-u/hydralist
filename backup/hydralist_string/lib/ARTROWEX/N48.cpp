...
N *
N48::getChild(const uint8_t k) const
{
...
bool
N48::remove(uint8_t k, bool force)
{
  if (count == 12 && !force) {
    return false;
  }
...
N *
N48::getSmallestChild(uint8_t start) const
{
...
N *
N48::getLargestChild(uint8_t end) const
{
